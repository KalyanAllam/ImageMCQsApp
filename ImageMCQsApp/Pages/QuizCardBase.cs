...
namespace ImageMCQsApp.Pages
{
    public class QuizCardBase : ComponentBase
    {
        ...
        protected byte[] failedImagedata = new byte[500] ;
        protected byte[] failedImagesol = new byte[500];
        ...
        protected async void AnswerSkip()
        {
            ...
            failedAnswer[failedIndex] = Questions[questionIndex].Answer;
            failedImagedata[failedIndex] = Convert.ToByte(Questions[questionIndex].Imagedata);
            failedImagesol[failedIndex] = Convert.ToByte(Questions[questionIndex].Imagesol);
            failedIndex++;
            questionIndex++;
        }
